...
<form action="/produtos/store" method="post">
  ...
  <input class="form-check-input" type="checkbox" id="ativo" name="ativo" onchange="return setaValorAtivo()" <?php echo (isset($ativo) && $ativo == '0') ? '' : 'checked' ?> value="<?php echo isset($ativo) ? $ativo: set_value('ativo') ?>>
